...
describe("errorHandlerPlugin", () => {
	it("returns unified payload with correlationId", async () => {
		...
		// Correlation ID might be autogenerated by fastify or request-id plugin if present.
		// Fastify native doesn't guarantee request.id unless configured.
		// But our handler reads it from request.id.
	});
