...
// Cookie-based refresh - still needs the variable defined for schema compatibility
// but tests can pass empty string when using cookies
export const Mutation_refreshTokenViaCookie =
  gql(`mutation Mutation_refreshTokenViaCookie($refreshToken: String!) {
    refreshToken(refreshToken: $refreshToken) {
        authenticationToken
        refreshToken
        user {
