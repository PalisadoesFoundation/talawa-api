...
declare module "gql.tada" {
	interface setupCache {
		...
		"query Query_fundCampaignPledge($input: QueryFundCampaignPledgeInput!) {\n  fundCampaignPledge(input: $input) {\n    id\n    note\n    amount\n  }\n}": TadaDocumentNode<
			...
			void
		>;
		"query Query_getPledgesByUserId($userId: QueryUserInput! , $where: QueryPledgeWhereInput, $orderBy: QueryPledgeOrderByInput) {\n  getPledgesByUserId(userId: $userId , where: $where , orderBy: $orderBy) {\n    id\n    note\n    amount\n    campaign {\n    endAt\n    }\n  }\n}": TadaDocumentNode<
			{
				getPledgesByUserId:
					| {
							id: string;
		...
		"mutation Mutation_createEvent($input: MutationCreateEventInput!) {\n    createEvent(input: $input) {\n        id\n        name\n        description\n        startAt\n        endAt\n        createdAt\n        creator{\n            id\n            name\n        }\n        organization {\n            id\n            countryCode\n        }\n    }\n}": TadaDocumentNode<
			...
			void
		>;
		"mutation Mutation_updateEvent($input: MutationUpdateEventInput!) {\n    updateEvent(input: $input) {\n        id\n        name\n        description\n        startAt\n        endAt\n        updatedAt\n        organization {\n            id\n            countryCode\n        }\n    }\n}": TadaDocumentNode<
			{
				updateEvent: {
					id: string;
					name: string | null;
