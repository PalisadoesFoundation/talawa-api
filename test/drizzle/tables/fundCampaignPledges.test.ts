    ...
    describe("fundCampaignPledgesTableRelations", () => {
        ...
        describe("campaign relation", () => {
            ...
            it("should have correct FK field mapping", () => {
                const fields = capturedRelations.campaign?.config?.fields;
            ...
            it("should have correct FK reference mapping", () => {
                const references = capturedRelations.campaign?.config?.references;
        ...
        describe("pledger relation", () => {
            ...
            it("should have correct FK field mapping", () => {
                const fields = capturedRelations.pledger?.config?.fields;
                expect(fields).toBeDefined();
                expect(Array.isArray(fields)).toBe(true);
                expect(fields?.length).toBe(1);
            });
            ...
            it("should have correct FK reference mapping", () => {
                const references = capturedRelations.pledger?.config?.references;
                expect(references).toBeDefined();
                expect(Array.isArray(references)).toBe(true);
                expect(references?.length).toBe(1);
            });
