...
// test("should include body for methods other than GET and HEAD", async () => {
...
// test("should not include body for GET and HEAD methods", async () => {
//     const req = {
//         protocol: "http",
//         hostname: "localhost",
//         url: "/api/resource",
//         method: "GET",  // Test with GET or HEAD method
//         body: { data: "some data" },
//     };
...
//     // Assert that body is undefined
//     const body = await fetchRequest.text();
//     expect(body).toBe("");  // Empty body for GET and HEAD
// });
