...
const filesToSkip = [
  ...
  "removeEventAttendee.ts",
  "removeSampleOrganization.ts",
  "removeUserCustomData.ts",
  "removeUserTag.ts",
  "togglePostPin.ts",
  "unassignUserTag.ts",
  ...
  "updateUserTag.ts",
  "advertisementsConnection.ts",
  "agendaItemById.ts",
  "eventsByOrganizationConnection.ts",
  "fundsByOrganization.ts",
  "getAllAgendaItems.ts",
  "getAllNotesForAgendaItem.ts",
  "getDonationByOrgIdConnection.ts",
  "getEventAttendee.ts",
  "getEventAttendeesByEventId.ts",
  "getNoteById.ts",
  "getVenueByOrgId.ts",
  "hasSubmittedFeedback.ts",
  "helperFunctions/getSort.ts",
  "organizationIsSample.ts",
  "getSort.ts",
