...
const organizationsConnection = async (parent, args, context, info) => {
    try {
        var inputArg = {};
        ...
        if (filterParam){
            ...
            if(filterParam.name_starts_with){
                var regexp = new RegExp("^"+ filterParam.name_starts_with);
                inputArg = {
                    ...inputArg,
                    name: regexp
                }
            ...
            if(filterParam.description_contains){
                inputArg = {
                    ...inputArg,
                    description: {"$regex": filterParam.description_contains, "$options": "i"}
                }
            }

            //Returns organizations with description starting with provided string
            if(filterParam.description_starts_with){
                var regexp = new RegExp("^"+ filterParam.description_starts_with);
                inputArg = {
                    ...inputArg,
                    description: regexp
                }
            ...
            if(filterParam.apiUrl_starts_with){
                var regexp = new RegExp("^"+ filterParam.apiUrl_starts_with);
                inputArg = {
                    ...inputArg,
                    apiUrl: regexp
                }
