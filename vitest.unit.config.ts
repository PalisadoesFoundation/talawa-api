...
// API_JWT_SECRET: when unset, this fallback prevents getSecret() from throwing TalawaRestError
// ("API_JWT_SECRET must be set in production") so password.test.ts and other files can static-import auth.
process.env.NODE_ENV = process.env.NODE_ENV ?? "test";
if (!process.env.API_JWT_SECRET) {
	process.env.API_JWT_SECRET = "unit-test-secret";
}
