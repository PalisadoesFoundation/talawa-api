...
export const mutationRequestPasswordResetInputSchema = usersTableInsertSchema
    .pick({
        emailAddress: true,
    });

export const MutationRequestPasswordResetInput = builder
    .inputRef<z.infer<typeof mutationRequestPasswordResetInputSchema>>("MutationRequestPasswordResetInput")
    .implement({
