...
builder.mutationField("acceptMembershipRequest", (t) =>
    t.field({
        ...
        resolve: async (_parent, args, ctx) => {
            ...
            const existingMembership = await ctx.drizzleClient.query.organizationMembershipsTable.findFirst({
                where: (fields, operators) => 
                    operators.and(
                        operators.eq(fields.organizationId, membershipRequest.organizationId),
            ...
            try {
                ...
                return {
                    success: true,
                    message: "Membership request accepted successfully. User added to organization.",
                };
            } catch (error) {
