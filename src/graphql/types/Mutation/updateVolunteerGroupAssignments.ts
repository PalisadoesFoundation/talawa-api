...
// import { MutationCreateVolunteerGroupAssignmentsInput, mutationCreateVolunteerGroupAssignmentsInputSchema } from "../../inputs/MutationCreateVolunteerGroupAssignments";
...
//         data: parsedArgs,
//         error,
//       } = mutationCreateVolunteerGroupAssignmentsArgumentsSchema.safeParse(args);
...
//         .leftJoin(
//           eventsTable,
//           eq(volunteerGroupsTable.eventId, eventsTable.id)
//         )
//         .leftJoin(
//           usersTable,
//           eq(sql`${usersTable.id}`, assigneeId)
//         )
//         .leftJoin(
//           usersTable,
//           eq(sql`${usersTable.id}`, currentUserId)
//         )
//         .leftJoin(
//           organizationMembershipsTable,
//           and(
//             eq(organizationMembershipsTable.organizationId, eventsTable.organizationId),
