...
export interface IPluginContext {
  ...
  graphql: any; // GraphQL schema builder
  pubsub: any; // PubSub instance
  logger: any; // Logger instance
  pluginManager?: any; // Reference to the plugin manager (optional to avoid circular dependency)
}
