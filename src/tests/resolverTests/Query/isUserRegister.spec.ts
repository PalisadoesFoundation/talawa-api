...
import { isUserRegister as isUserRegisterResolver } from '../../../lib/resolvers/Query/isUserRegister';
import {
  User,
  Organization,
  Event,
...
import { QueryIsUserRegisterArgs } from '../../../generated/graphQLTypescriptTypes';
