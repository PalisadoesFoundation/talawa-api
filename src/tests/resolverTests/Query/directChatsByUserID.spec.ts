...
import { directChatsByUserID as directChatsByUserIDResolver } from '../../../lib/resolvers/Query/directChatsByUserID';
import {
  User,
  Organization,
  DirectChat,
...
import { QueryDirectChatsByUserIdArgs } from '../../../generated/graphQLTypescriptTypes';
...
describe('resolvers -> Query -> directChatsByUserID', () => {
  test(`throws NotFoundError if no directChats exists with directChats.users
  ...
  test(`returns list of all directChats with directChat.users containing the user
