...
import { MutationSendMessageToGroupChatArgs } from '../../../generated/graphQLTypescriptTypes';
import { connect, disconnect } from '../../../db';
import { sendMessageToGroupChat as sendMessageToGroupChatResolver } from '../../../lib/resolvers/Mutation/sendMessageToGroupChat';
import {
  CHAT_NOT_FOUND,
  USER_NOT_AUTHORIZED,
  USER_NOT_FOUND,
...
describe('resolvers -> Mutation -> sendMessageToGroupChat', () => {
  ...
  it(`creates the groupChatMessage and returns it`, async () => {
    ...
    const pubsub = {
      publish: (
        action: 'MESSAGE_SENT_TO_GROUP_CHAT',
        payload: {
