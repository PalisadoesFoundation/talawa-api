import { DonationWhereInput, InputMaybe, QueryResolvers } from "../../types/generatedGraphQLTypes";
 ...
 */
export const getDonationByOrgIdConnection: QueryResolvers["getDonationByOrgIdConnection"] = async (
  _parent,
  args
) => {
