...
const getDonations = require('./donation_query/getDonations');
const getDonationById = require('./donation_query/getDonationById');
const getDonationByOrgId = require('./donation_query/getDonationByOrgId');
const Query = {
  me,
  user,
  users,
