...
describe('Organizations Connection Resolvers', () => {
    ...
    test('Organizations Connection with Filter as Id', async () => {
        ...
        expect(
            orgConnectionResponse.data.data.organizationsConnection.length
        ).toEqual(1);

        expect(
            orgConnectionResponse.data.data.organizationsConnection[0]
        ).toEqual(
            expect.objectContaining({
                _id: createdOrgId,
