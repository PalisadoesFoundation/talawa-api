...
import { createTagsAndAssignToUser, testUserTagType } from "../../helpers/tags";
import {
...
beforeAll(async () => {
  ...
  [testUser, testOrganization, testTags] = await createTagsAndAssignToUser(5);
  testTagIds = testTags.map((tag) => tag!._id);
