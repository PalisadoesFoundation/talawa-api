...
let testUserNotCreatorOfEventProject: Interface_User & Document<any, any, Interface_User>
...
describe('resolvers -> Mutation -> removeEventProject', () => {
    it('Should throw an error if the user is not found', async () => {
        ...
        const {removeEventProject} = await import("../../../src/resolvers/Mutation/removeEventProject")
    ...
    it('Should throw an error if the eventProject is not found and IN_PRODUCTION is true', async () => {
        ...
        try {
            ...
            expect(error.message).toBe(`Translated ${EVENT_PROJECT_NOT_FOUND_MESSAGE}`)
        }
    })
