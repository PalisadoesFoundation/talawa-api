...
describe('chat resolvers', function () {
  ...
  test('create direct chat', function _callee2() {
    var createdOrgResponse, nameForNewUser, email, createNewUserResponse, signUpData, newUserId, createDirectChatResponse, createDirectChatData;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 8;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n              mutation {\n                  signUp(data: {\n                  firstName:\"".concat(nameForNewUser, "\",\n                  lastName:\"").concat(nameForNewUser, "\"\n                  email: \"").concat(email, "\"\n                  password:\"password\"\n                  }) {\n                  user{\n                    _id\n                  }\n                  accessToken\n                  }\n              }\n              ")
            }));
          ...
          case 8:
            ...
            _context2.next = 13;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n        mutation{\n            createDirectChat(data: {\n              organizationId: \"".concat(createdOrgId, "\"\n              userIds: [\"").concat(loggedInUserId, "\", \"").concat(newUserId, "\"]\n            }){\n              _id\n            }\n          }\n                ")
            }, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
          ...
          case 13:
            ...
            expect(createDirectChatData.data.createDirectChat).toEqual(expect.objectContaining({
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n        mutation{\n          sendMessageToDirectChat(chatId: \"".concat(createdDirectChatId, "\", messageContent: \"this is a test message\"){\n            _id\n          }\n        }\n            ")
            }, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
          ...
          case 2:
            ...
            expect(sendMessageToADirectChatData.data.sendMessageToDirectChat).toEqual(expect.objectContaining({
              _id: expect.any(String)
            }));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n    mutation{\n      removeDirectChat(chatId:\"".concat(createdDirectChatId, "\", organizationId:\"").concat(createdOrgId, "\") {\n        _id\n    }\n    }\n            ")
            }, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
          ...
          case 2:
            ...
            expect(removeDirectChatData.data.removeDirectChat).toEqual(expect.objectContaining({
              _id: expect.any(String)
            }));
  ...
  test('create group chat', function _callee5() {
    var nameForNewUser, email, createNewUserResponse, signUpData, newUserId, createGroupChatResponse, createGroupChatData;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            expect(createGroupChatData.data.createGroupChat).toEqual(expect.objectContaining({
              _id: expect.any(String)
            }));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n        mutation{\n          sendMessageToGroupChat(chatId: \"".concat(createdGroupChatId, "\", messageContent: \"this is a test message\"){\n            _id\n          }\n        }\n            ")
            }, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
          ...
          case 2:
            ...
            expect(sendMessageToAGroupChatData.data.sendMessageToGroupChat).toEqual(expect.objectContaining({
              _id: expect.any(String)
            }));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return regeneratorRuntime.awrap(axios.post(URL, {
              query: "\n    mutation{\n      removeGroupChat(chatId:\"".concat(createdGroupChatId, "\") {\n        _id\n    }\n    }\n            ")
            }, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
          ...
          case 2:
            ...
            expect(removeGroupChatData.data.removeGroupChat).toEqual(expect.objectContaining({
              _id: expect.any(String)
            }));
