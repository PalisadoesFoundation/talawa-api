...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/2c2e70a/src/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/2c2e70a/src/env.ts#L36)
