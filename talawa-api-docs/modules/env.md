...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/3a8a11a/src/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/3a8a11a/src/env.ts#L36)
