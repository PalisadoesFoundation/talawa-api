...
[src/env.ts:3](https://github.com/PalisadoesFoundation/talawa-api/blob/612a320/src/env.ts#L3)
...
[src/env.ts:36](https://github.com/PalisadoesFoundation/talawa-api/blob/612a320/src/env.ts#L36)
