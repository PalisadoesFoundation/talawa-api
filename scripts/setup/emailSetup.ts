...
import { SetupAnswers, validateEmail } from "./setup";
    ...
    try {
        ...
        if (sendTest) {
            ...
            try {
                ...
                const { EmailService } = await import("../../src/services/ses/EmailService");
                ...
                const result = await service.sendEmail({
                    ...
                    htmlBody: "<h1>It Works!</h1><p>Your Talawa API email configuration is correct.</p>",
                    userId: null,
                });
                ...
                if (result.success) {
                    ...
                    console.log("Please check your credentials and ensure the 'From' address is verified in SES.");
                }
            } catch (error) {
