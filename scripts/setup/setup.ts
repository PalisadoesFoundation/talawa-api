...
// These functions are now exported from their respective modules in services/
// and are kept here for backward compatibility if needed, or renamed to avoid conflict.
// However, the internal implementation will be removed to avoid duplication.
