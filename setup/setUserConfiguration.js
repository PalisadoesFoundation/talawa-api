...
const display_heading = require("./utils/displayHeading");
const input = require("./utils/input");
const checkMongoURL = require("./utils/checkMongoURL");
 ...
 */
const setUserConfiguration = async (path) => {
  try {
    //Display message
    ...
    const isValidURL = await checkMongoURL(response["MONGO_DB_URL"]);
...
module.exports = setUserConfiguration;
