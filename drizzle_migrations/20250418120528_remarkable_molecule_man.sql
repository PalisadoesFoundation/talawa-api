...
ALTER TABLE "actions" ADD CONSTRAINT "actions_assignee_id_users_id_fk" FOREIGN KEY ("actor_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "actions_assignee_id_index" ON "actions" USING btree ("actor_id");--> statement-breakpoint
