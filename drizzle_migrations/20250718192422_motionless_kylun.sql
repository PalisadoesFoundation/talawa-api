CREATE TABLE "notification_audience" (
	...
	CONSTRAINT "notification_audience_notification_id_target_type_target_id_pk" PRIMARY KEY("notification_id","target_type","target_id")
);
...
CREATE INDEX "notification_audience_target_type_index" ON "notification_audience" USING btree ("target_type");--> statement-breakpoint
CREATE INDEX "notification_audience_target_id_index" ON "notification_audience" USING btree ("target_id");--> statement-breakpoint
