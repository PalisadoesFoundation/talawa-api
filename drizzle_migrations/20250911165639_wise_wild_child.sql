...
CREATE TABLE "action_exceptions" (
	...
	CONSTRAINT "action_exceptions_action_id_event_id_unique" UNIQUE("action_id","event_id")
);
--> statement-breakpoint
...
ALTER TABLE "action_exceptions" ADD CONSTRAINT "action_exceptions_action_id_actions_id_fk" FOREIGN KEY ("action_id") REFERENCES "public"."actions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_exceptions" ADD CONSTRAINT "action_exceptions_event_id_recurring_event_instances_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."recurring_event_instances"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_exceptions" ADD CONSTRAINT "action_exceptions_assignee_id_users_id_fk" FOREIGN KEY ("assignee_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "action_exceptions" ADD CONSTRAINT "action_exceptions_category_id_action_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."action_categories"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "actions" ADD CONSTRAINT "actions_recurring_event_instance_id_recurring_event_instances_id_fk" FOREIGN KEY ("recurring_event_instance_id") REFERENCES "public"."recurring_event_instances"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
