...
1. Please read our [CONTRIBUTING.md](https://github.com/PalisadoesFoundation/talawa-api/blob/develop/CONTRIBUTING.md) document for details on our testing policy.
...
1. Please follow the [PR template](https://github.com/PalisadoesFoundation/talawa-api/blob/master/.github/PR_TEMPLATE/pr-template.md). Ensure the PR title clearly describes the problem it is solving. In the description, include the relevant issue number, snapshots, and videos after changes are added.
