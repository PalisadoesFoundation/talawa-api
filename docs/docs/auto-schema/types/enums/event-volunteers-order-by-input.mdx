---
id: event-volunteers-order-by-input
title: EventVolunteersOrderByInput
---
...
#### [<code style={{ fontWeight: 'normal' }}>EventVolunteersOrderByInput.<b>hoursVolunteered_ASC</b></code>](#)

Order by hours volunteered in ascending order.

#### [<code style={{ fontWeight: 'normal' }}>EventVolunteersOrderByInput.<b>hoursVolunteered_DESC</b></code>](#)
