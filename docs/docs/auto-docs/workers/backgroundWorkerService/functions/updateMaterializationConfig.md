...
Defined in: [src/workers/backgroundWorkerService.ts:484](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L484)
