...
Defined in: [src/workers/backgroundWorkerService.ts:284](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L284)
