...
Defined in: [src/workers/backgroundWorkerService.ts:290](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L290)
