...
Defined in: [src/workers/backgroundWorkerService.ts:414](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L414)
