...
Defined in: [src/workers/backgroundWorkerService.ts:488](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L488)
