...
Defined in: [src/workers/backgroundWorkerService.ts:487](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L487)
