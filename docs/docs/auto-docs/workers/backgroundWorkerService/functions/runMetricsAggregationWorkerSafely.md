...
Defined in: [src/workers/backgroundWorkerService.ts:255](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L255)
