...
Defined in: [src/workers/backgroundWorkerService.ts:173](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L173)
