...
Defined in: [src/workers/backgroundWorkerService.ts:154](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L154)
