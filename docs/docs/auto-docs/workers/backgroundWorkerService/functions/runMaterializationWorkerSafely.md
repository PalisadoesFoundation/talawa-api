...
Defined in: [src/workers/backgroundWorkerService.ts:152](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L152)
