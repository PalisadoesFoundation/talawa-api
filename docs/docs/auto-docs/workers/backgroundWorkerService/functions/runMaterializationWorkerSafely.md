...
Defined in: [src/workers/backgroundWorkerService.ts:176](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L176)
