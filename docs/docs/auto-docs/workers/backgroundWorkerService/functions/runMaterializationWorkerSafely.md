...
Defined in: [src/workers/backgroundWorkerService.ts:172](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L172)
