...
Defined in: [src/workers/backgroundWorkerService.ts:191](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L191)
