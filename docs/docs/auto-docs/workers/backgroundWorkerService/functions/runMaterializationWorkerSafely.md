...
Defined in: [src/workers/backgroundWorkerService.ts:165](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L165)
