...
Defined in: [src/workers/backgroundWorkerService.ts:181](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L181)
