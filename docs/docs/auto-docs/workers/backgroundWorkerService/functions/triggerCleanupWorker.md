...
Defined in: [src/workers/backgroundWorkerService.ts:286](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L286)
