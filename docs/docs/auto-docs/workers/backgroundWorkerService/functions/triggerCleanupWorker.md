...
Defined in: [src/workers/backgroundWorkerService.ts:246](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L246)
