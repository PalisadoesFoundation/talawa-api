...
Defined in: [src/workers/backgroundWorkerService.ts:317](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L317)
