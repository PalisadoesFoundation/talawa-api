...
Defined in: [src/workers/backgroundWorkerService.ts:399](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L399)
