...
Defined in: [src/workers/backgroundWorkerService.ts:343](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L343)
