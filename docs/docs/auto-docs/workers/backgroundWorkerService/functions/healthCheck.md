...
Defined in: [src/workers/backgroundWorkerService.ts:248](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L248)
