...
Defined in: [src/workers/backgroundWorkerService.ts:346](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L346)
