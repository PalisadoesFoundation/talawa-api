...
Defined in: [src/workers/backgroundWorkerService.ts:456](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L456)
