...
Defined in: [src/workers/backgroundWorkerService.ts:389](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L389)
