...
Defined in: [src/workers/backgroundWorkerService.ts:224](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L224)
