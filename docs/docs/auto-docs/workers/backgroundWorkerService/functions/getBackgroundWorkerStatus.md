...
Defined in: [src/workers/backgroundWorkerService.ts:378](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L378)
