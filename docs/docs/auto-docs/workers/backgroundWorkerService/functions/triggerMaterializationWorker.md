...
Defined in: [src/workers/backgroundWorkerService.ts:253](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L253)
