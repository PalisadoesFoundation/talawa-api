...
Defined in: [src/workers/backgroundWorkerService.ts:296](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L296)
