...
Defined in: [src/workers/backgroundWorkerService.ts:231](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/backgroundWorkerService.ts#L231)
