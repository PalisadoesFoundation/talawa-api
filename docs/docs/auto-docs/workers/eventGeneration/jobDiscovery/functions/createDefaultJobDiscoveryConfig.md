...
Defined in: [src/workers/eventGeneration/jobDiscovery.ts:353](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/eventGeneration/jobDiscovery.ts#L353)
