...
Defined in: [src/workers/eventGeneration/windowManager.ts:346](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/eventGeneration/windowManager.ts#L346)
