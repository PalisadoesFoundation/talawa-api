...
Defined in: [src/workers/eventGeneration/windowManager.ts:90](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/workers/eventGeneration/windowManager.ts#L90)
