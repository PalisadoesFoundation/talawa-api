...
Defined in: [src/graphql/enums/UserEducationGrade.ts:4](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/enums/UserEducationGrade.ts#L4)
