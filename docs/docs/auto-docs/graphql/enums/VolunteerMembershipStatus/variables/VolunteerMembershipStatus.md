...
Defined in: [src/graphql/enums/VolunteerMembershipStatus.ts:7](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/enums/VolunteerMembershipStatus.ts#L7)
