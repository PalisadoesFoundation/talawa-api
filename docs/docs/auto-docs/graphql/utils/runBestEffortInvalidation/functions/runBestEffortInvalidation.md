...
Defined in: [src/graphql/utils/runBestEffortInvalidation.ts:11](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/utils/runBestEffortInvalidation.ts#L11)
