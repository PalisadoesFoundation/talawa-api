...
Defined in: [src/graphql/utils/withResolverCache.ts:82](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/utils/withResolverCache.ts#L82)
