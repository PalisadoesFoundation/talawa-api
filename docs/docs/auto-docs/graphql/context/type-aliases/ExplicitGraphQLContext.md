...
Defined in: [src/graphql/context.ts:140](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/context.ts#L140)

Request-scoped performance tracker for monitoring operation durations,
cache hits/misses, slow queries, and GraphQL complexity scores.
