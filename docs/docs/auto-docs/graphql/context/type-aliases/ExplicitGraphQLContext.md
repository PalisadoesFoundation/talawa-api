...
Defined in: [src/graphql/context.ts:76](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/context.ts#L76)
...
Defined in: [src/graphql/context.ts:110](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/context.ts#L110)
