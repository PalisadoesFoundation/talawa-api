...
# Function: VolunteerMembershipUpdatedByResolver()
...
Defined in: [src/graphql/types/EventVolunteerMembership/updatedBy.ts:10](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/EventVolunteerMembership/updatedBy.ts#L10)
