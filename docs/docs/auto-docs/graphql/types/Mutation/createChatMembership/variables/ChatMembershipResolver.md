...
# Variable: ChatMembershipResolver

> `const` **ChatMembershipResolver**: `object`

Defined in: [src/graphql/types/Mutation/createChatMembership.ts:101](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Mutation/createChatMembership.ts#L101)

## Type Declaration

### createChatMembership()

> **createChatMembership**: (`_parent`, `args`, `ctx`) => `Promise`\<`ChatWithMemberships`\>
