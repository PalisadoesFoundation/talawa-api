...
Defined in: [src/graphql/types/User/createdOrganizations.ts:17](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/User/createdOrganizations.ts#L17)
