...
Defined in: [src/graphql/types/User/organizationsWhereMember.ts:78](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/User/organizationsWhereMember.ts#L78)
