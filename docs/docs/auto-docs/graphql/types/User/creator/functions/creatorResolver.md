...
Defined in: [src/graphql/types/User/creator.ts:16](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/User/creator.ts#L16)
...
The user who created this user, or null if no creator.
