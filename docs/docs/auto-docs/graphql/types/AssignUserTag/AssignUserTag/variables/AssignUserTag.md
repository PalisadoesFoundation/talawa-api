...
Defined in: [src/graphql/types/AssignUserTag/AssignUserTag.ts:6](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AssignUserTag/AssignUserTag.ts#L6)
