...
Defined in: [src/graphql/types/FundCampaignPledge/updater.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/FundCampaignPledge/updater.ts#L9)
