...
Defined in: [src/graphql/types/ActionItemCategory/updater.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/ActionItemCategory/updater.ts#L9)
