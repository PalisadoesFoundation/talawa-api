...
Defined in: [src/graphql/types/Fund/organization.ts:6](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Fund/organization.ts#L6)
