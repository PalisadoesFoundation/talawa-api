...
Defined in: [src/graphql/types/ActionItem/updater.ts:21](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/ActionItem/updater.ts#L21)
