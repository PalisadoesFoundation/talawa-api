...
Defined in: [src/graphql/types/Organization/MembershipRequestObject.ts:23](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Organization/MembershipRequestObject.ts#L23)
