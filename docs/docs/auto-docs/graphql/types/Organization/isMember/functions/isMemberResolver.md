...
Defined in: [src/graphql/types/Organization/isMember.ts:20](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Organization/isMember.ts#L20)
