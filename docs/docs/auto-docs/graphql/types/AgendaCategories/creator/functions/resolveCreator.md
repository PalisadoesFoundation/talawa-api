...
Defined in: [src/graphql/types/AgendaCategories/creator.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AgendaCategories/creator.ts#L9)
