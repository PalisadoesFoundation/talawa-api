...
Defined in: [src/graphql/types/AgendaCategories/updater.ts:8](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AgendaCategories/updater.ts#L8)
