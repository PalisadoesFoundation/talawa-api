...
Defined in: [src/graphql/types/Query/getUserPledgesByCampaignID.ts:14](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Query/getUserPledgesByCampaignID.ts#L14)
