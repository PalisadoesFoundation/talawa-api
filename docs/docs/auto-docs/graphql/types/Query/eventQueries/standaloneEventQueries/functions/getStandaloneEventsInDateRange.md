...
Defined in: [src/graphql/types/Query/eventQueries/standaloneEventQueries.ts:49](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/Query/eventQueries/standaloneEventQueries.ts#L49)
