...
Defined in: [src/graphql/types/AgendaItem/updater.ts:7](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AgendaItem/updater.ts#L7)
