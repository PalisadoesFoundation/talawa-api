...
Defined in: [src/graphql/types/AgendaItem/creator.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AgendaItem/creator.ts#L9)
