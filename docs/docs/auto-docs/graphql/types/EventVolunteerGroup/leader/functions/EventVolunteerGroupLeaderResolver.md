...
Defined in: [src/graphql/types/EventVolunteerGroup/leader.ts:10](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/EventVolunteerGroup/leader.ts#L10)
