...
Defined in: [src/graphql/types/EventVolunteer/updater.ts:10](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/EventVolunteer/updater.ts#L10)
