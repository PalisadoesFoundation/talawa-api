...
Defined in: [src/graphql/types/EventVolunteer/user.ts:10](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/EventVolunteer/user.ts#L10)
