...
Defined in: [src/graphql/types/AgendaCategory/updater.ts:8](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/types/AgendaCategory/updater.ts#L8)
