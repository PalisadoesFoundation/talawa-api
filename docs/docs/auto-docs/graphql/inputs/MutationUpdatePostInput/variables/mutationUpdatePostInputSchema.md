...
Defined in: [src/graphql/inputs/MutationUpdatePostInput.ts:12](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUpdatePostInput.ts#L12)
