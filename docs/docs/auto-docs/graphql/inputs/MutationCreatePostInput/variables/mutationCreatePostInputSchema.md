...
Defined in: [src/graphql/inputs/MutationCreatePostInput.ts:50](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreatePostInput.ts#L50)
