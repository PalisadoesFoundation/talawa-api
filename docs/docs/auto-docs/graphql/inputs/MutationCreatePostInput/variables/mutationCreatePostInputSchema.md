...
Defined in: [src/graphql/inputs/MutationCreatePostInput.ts:51](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreatePostInput.ts#L51)
