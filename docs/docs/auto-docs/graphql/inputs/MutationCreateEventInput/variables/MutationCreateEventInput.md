...
Defined in: [src/graphql/inputs/MutationCreateEventInput.ts:42](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreateEventInput.ts#L42)
