...
Defined in: [src/graphql/inputs/QuerySignInInput.ts:13](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/QuerySignInInput.ts#L13)
