...
Defined in: [src/graphql/inputs/MutationUpdateCommunityInput.ts:34](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUpdateCommunityInput.ts#L34)
