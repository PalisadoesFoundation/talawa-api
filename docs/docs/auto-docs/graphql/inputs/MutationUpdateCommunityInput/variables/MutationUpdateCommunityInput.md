...
Defined in: [src/graphql/inputs/MutationUpdateCommunityInput.ts:36](https://github.com/singhaditya73/talawa-api/blob/0e11f9efaf3110cae96d9bcec23fad73db6e3b03/src/graphql/inputs/MutationUpdateCommunityInput.ts#L36)
