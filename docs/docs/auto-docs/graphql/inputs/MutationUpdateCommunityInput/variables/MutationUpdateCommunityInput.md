...
Defined in: [src/graphql/inputs/MutationUpdateCommunityInput.ts:36](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUpdateCommunityInput.ts#L36)
