...
Defined in: [src/graphql/inputs/MutationCreateAgendaCategory.ts:5](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreateAgendaCategory.ts#L5)
