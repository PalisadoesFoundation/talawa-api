...
Defined in: [src/graphql/inputs/EventVolunteerGroupWhereInput.ts:26](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/EventVolunteerGroupWhereInput.ts#L26)
