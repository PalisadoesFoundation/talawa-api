...
Defined in: [src/graphql/inputs/MutationSendEventInvitationsInput.ts:37](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationSendEventInvitationsInput.ts#L37)
