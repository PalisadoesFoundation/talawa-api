...
> `const` **mutationUpdateFundCampaignPledgeInputSchema**: `ZodObject`\<\{ `amount`: `ZodOptional`\<`ZodNumber`\>; `id`: `ZodString`; `note`: `ZodNullable`\<`ZodOptional`\<`ZodNullable`\<`ZodString`\>\>\>; \}, \{ \}\>
