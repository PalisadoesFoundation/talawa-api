...
Defined in: [src/graphql/inputs/MutationSignUpInput.ts:13](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationSignUpInput.ts#L13)
