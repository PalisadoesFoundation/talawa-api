...
Defined in: [src/graphql/inputs/MutationDeleteThisAndFollowingEventsInput.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationDeleteThisAndFollowingEventsInput.ts#L9)
