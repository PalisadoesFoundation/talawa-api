...
Defined in: [src/graphql/inputs/MutationCreateActionItemCategoryInput.ts:12](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreateActionItemCategoryInput.ts#L12)
