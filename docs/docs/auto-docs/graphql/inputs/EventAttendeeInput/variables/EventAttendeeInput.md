...
Defined in: [src/graphql/inputs/EventAttendeeInput.ts:26](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/EventAttendeeInput.ts#L26)
