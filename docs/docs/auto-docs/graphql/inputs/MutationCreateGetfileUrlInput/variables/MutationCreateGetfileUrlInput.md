...
Defined in: [src/graphql/inputs/MutationCreateGetfileUrlInput.ts:9](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationCreateGetfileUrlInput.ts#L9)
