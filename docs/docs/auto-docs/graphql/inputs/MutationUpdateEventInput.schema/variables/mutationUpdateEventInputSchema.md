...
Defined in: [src/graphql/inputs/MutationUpdateEventInput.schema.ts:5](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUpdateEventInput.schema.ts#L5)
