...
Defined in: [src/graphql/inputs/MutationUnblockUserInput.ts:5](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUnblockUserInput.ts#L5)
