...
Defined in: [src/graphql/inputs/MutationUpdateAgendaItemInput.ts:52](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/graphql/inputs/MutationUpdateAgendaItemInput.ts#L52)
