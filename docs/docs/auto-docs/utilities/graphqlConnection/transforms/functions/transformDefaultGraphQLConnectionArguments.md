...
Defined in: [src/utilities/graphqlConnection/transforms.ts:8](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/graphqlConnection/transforms.ts#L8)
