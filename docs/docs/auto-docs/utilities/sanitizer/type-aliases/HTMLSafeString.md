...
Defined in: [src/utilities/sanitizer.ts:15](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/sanitizer.ts#L15)
...
> `readonly` **\_\_brand**: `"HTMLSafeString"`
