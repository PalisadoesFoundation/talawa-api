...
Defined in: [src/utilities/auth/oauth/providers/GitHubOAuthProvider.ts:94](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/auth/oauth/providers/GitHubOAuthProvider.ts#L94)
