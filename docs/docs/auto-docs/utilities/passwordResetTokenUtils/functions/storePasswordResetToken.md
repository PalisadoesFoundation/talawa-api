...
Defined in: [src/utilities/passwordResetTokenUtils.ts:71](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/passwordResetTokenUtils.ts#L71)
