...
Defined in: [src/utilities/passwordResetTokenUtils.ts:52](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/passwordResetTokenUtils.ts#L52)
