...
Defined in: [src/utilities/recurringEvent/types.ts:51](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/recurringEvent/types.ts#L51)
