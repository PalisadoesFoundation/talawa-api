...
Defined in: [src/utilities/recurringEvent/validation.ts:84](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/recurringEvent/validation.ts#L84)
