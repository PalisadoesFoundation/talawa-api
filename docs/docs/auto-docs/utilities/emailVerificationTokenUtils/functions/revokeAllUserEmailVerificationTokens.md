...
Defined in: [src/utilities/emailVerificationTokenUtils.ts:168](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/emailVerificationTokenUtils.ts#L168)
