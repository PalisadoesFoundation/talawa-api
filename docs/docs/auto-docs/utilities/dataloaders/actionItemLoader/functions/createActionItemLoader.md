...
Defined in: [src/utilities/dataloaders/actionItemLoader.ts:34](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/dataloaders/actionItemLoader.ts#L34)
