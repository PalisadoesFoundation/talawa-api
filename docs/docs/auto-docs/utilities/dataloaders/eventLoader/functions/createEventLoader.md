...
Defined in: [src/utilities/dataloaders/eventLoader.ts:35](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/utilities/dataloaders/eventLoader.ts#L35)
