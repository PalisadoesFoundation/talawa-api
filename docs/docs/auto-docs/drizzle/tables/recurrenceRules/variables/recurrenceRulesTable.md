...
Defined in: [src/drizzle/tables/recurrenceRules.ts:33](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/recurrenceRules.ts#L33)
