...
Defined in: [src/drizzle/tables/passwordResetTokens.ts:73](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/passwordResetTokens.ts#L73)
