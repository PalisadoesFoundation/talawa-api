...
Defined in: [src/drizzle/tables/recurringEventInstances.ts:223](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/recurringEventInstances.ts#L223)
