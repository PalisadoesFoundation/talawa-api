...
Defined in: [src/drizzle/tables/NotificationLog.ts:125](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/NotificationLog.ts#L125)
