...
Defined in: [src/drizzle/tables/eventVolunteerGroupExceptions.ts:42](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/eventVolunteerGroupExceptions.ts#L42)
