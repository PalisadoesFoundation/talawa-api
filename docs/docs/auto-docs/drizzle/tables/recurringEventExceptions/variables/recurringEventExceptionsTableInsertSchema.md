...
Defined in: [src/drizzle/tables/recurringEventExceptions.ts:151](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/recurringEventExceptions.ts#L151)
