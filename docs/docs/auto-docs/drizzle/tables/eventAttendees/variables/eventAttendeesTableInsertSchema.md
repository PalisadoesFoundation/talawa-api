...
Defined in: [src/drizzle/tables/eventAttendees.ts:206](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/eventAttendees.ts#L206)
