...
# Variable: agendaItemAttachmentMimeTypePgEnum

> `const` **agendaItemAttachmentMimeTypePgEnum**: `PgEnum`\<\[`"image/avif"`, `"image/jpeg"`, `"image/png"`, `"image/webp"`, `"video/mp4"`, `"video/webm"`, `"video/quicktime"`\]\>
