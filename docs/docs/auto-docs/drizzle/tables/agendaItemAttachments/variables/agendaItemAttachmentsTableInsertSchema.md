...
Defined in: [src/drizzle/tables/agendaItemAttachments.ts:124](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/agendaItemAttachments.ts#L124)
