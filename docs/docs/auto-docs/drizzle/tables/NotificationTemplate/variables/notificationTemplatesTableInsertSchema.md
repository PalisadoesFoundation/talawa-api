...
Defined in: [src/drizzle/tables/NotificationTemplate.ts:133](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/NotificationTemplate.ts#L133)
