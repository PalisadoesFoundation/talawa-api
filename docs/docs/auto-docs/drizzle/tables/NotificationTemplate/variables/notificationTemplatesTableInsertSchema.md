...
Defined in: [src/drizzle/tables/NotificationTemplate.ts:124](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/NotificationTemplate.ts#L124)
