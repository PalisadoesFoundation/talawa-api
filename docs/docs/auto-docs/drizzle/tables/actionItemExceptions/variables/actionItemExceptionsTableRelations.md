...
Defined in: [src/drizzle/tables/actionItemExceptions.ts:72](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/actionItemExceptions.ts#L72)
