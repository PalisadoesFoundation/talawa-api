...
Defined in: [src/drizzle/tables/organizationMemberships.ts:130](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/organizationMemberships.ts#L130)
