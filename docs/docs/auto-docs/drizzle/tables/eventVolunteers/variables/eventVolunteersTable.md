...
Defined in: [src/drizzle/tables/eventVolunteers.ts:21](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/tables/eventVolunteers.ts#L21)
