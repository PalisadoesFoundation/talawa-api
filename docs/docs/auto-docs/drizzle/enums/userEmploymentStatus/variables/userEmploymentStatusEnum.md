...
Defined in: [src/drizzle/enums/userEmploymentStatus.ts:6](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/enums/userEmploymentStatus.ts#L6)
