...
Defined in: [src/drizzle/enums/advertisementAttachmentMimeType.ts:8](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/drizzle/enums/advertisementAttachmentMimeType.ts#L8)
