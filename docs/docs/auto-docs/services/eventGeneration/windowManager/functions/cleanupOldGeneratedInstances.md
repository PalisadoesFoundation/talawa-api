...
Defined in: [src/services/eventGeneration/windowManager.ts:173](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/windowManager.ts#L173)
