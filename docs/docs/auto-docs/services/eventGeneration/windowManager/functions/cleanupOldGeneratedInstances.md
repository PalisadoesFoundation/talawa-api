...
Defined in: [src/services/eventGeneration/windowManager.ts:164](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/windowManager.ts#L164)
