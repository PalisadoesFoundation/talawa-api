...
Defined in: [src/services/eventGeneration/windowManager.ts:236](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/windowManager.ts#L236)
