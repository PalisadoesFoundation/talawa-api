...
Defined in: [src/services/eventGeneration/windowManager.ts:23](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/windowManager.ts#L23)
