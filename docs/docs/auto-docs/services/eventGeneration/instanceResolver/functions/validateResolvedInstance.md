...
Defined in: [src/services/eventGeneration/instanceResolver.ts:285](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/instanceResolver.ts#L285)
