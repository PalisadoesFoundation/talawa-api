...
Defined in: [src/services/eventGeneration/occurrenceCalculator.ts:264](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/eventGeneration/occurrenceCalculator.ts#L264)
