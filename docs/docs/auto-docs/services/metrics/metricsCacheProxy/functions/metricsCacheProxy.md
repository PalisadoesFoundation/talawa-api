...
Defined in: [src/services/metrics/metricsCacheProxy.ts:12](https://github.com/PalisadoesFoundation/talawa-api/tree/mainsrc/services/metrics/metricsCacheProxy.ts#L12)
