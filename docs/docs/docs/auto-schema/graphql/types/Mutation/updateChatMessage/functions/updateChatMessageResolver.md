...
Defined in: [src/graphql/types/Mutation/updateChatMessage.ts:19](https://github.com/NishantSinghhhhh/talawa-api/blob/cecfd40a68e5e0e9c8a0b8efd045a3c4381a2c01/src/graphql/types/Mutation/updateChatMessage.ts#L19)
