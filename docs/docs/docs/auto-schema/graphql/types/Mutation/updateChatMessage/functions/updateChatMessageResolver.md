...
Defined in: [src/graphql/types/Mutation/updateChatMessage.ts:19](https://github.com/PratapRathi/talawa-api/blob/8be1a1231af103d298d6621405c956dc45d3a73a/src/graphql/types/Mutation/updateChatMessage.ts#L19)
