...
const ManagementFeaturesCard = () => {
  return (
    <div className="card__container card__wide">
      <h2 className="Heading">More Effective Management</h2>
      <div className="management__cards">
        <div className="management__card card__general">
          ...
          <div>
            ...
            <p className="card__description">
              Easily schedule events and track attendance. Reports show who’s
              coming, and how often
            </p>
          </div>
        </div>
        <div className="management__card card__general">
          ...
          <div>
            ...
            <p className="card__description">
              Stay in contact with your membership with individual or group
              emails, now and in the future
            </p>
          </div>
        </div>
        <div className="management__card card__general">
          ...
          <div>
            ...
            <p className="card__description">
              Track your volunteer time and their activity tasks. Make your
              planning a success
            </p>
          </div>
        </div>
        <div className="management__card card__general">
          ...
          <div>
            ...
            <p className="card__description">
              Our intuitive design helps streamline work processes and increases
              adoption so everyone can benefit
            </p>
          </div>
        </div>
      </div>
